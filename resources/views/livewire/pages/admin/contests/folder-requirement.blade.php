<div>
      ...
      <div class="border-gray-200 border rounded-[2.5px] py-1.5 px-2.5 shadow-sm">
        ...
        @else
          <header class="flex justify-between item-center text-[13px] leading-4 py-0.5">
            <p class="cursor-pointer font-medium" x-on:click="open = !open"><span class="text-[#2477bc] mr-2">Seccion:</span>{{ $item->name }}</p>
            <div wire:ignore>
  ...
  <div x-data="{open: false}" class="mt-4">
    ...
    <article class="border shadow p-3 rounded-[2.5px]" x-show="open">
      <p class="mb-3 text-[13px] leading-4 text-[#2477bc] font-medium text-center">Agregar nuevo folder</p>
      <div class="mb-3">
