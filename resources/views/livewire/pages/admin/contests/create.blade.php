<div class="pt-5">
  <div class="rounded border border-[#F0F1F2] bg-white shadow-sm px-4 py-4">
    <form wire:submit="createContest" enctype="multipart/form-data">
      <div class="grid gap-4 lg:grid-cols-2">
        ...
        <div class="space-y-2">
          ...
          <div>
            <x-input-label for="subtitle" :value="__('Subtitulo del concurso')" />
